...
var helpRows = []helpRow{
	...
	{"Planned focus", "minutes or pomos (75m or 3p); syncs to TickTick", false},
	{"Repeat", "none · daily · weekdays · weekly · custom RRULE/ERULE", false},
	...
	{"t", "jump to today; center the current-time line in Day/Week", false},
	{"Enter", "open selected day (month/week → day view · year → month)", false},
	{"x", "check in or undo selected task in Day or Week view", false},
	{"o", "show / hide overdue tasks in Day (hidden tasks still count in plan)", false},
	...
	{"+ / -", "increase / decrease the persisted daily pomodoro goal", false},
	{"z", "toggle timeline density (compact · stretch)", false},
	{"[ / ]", "previous / next timeline day", false},
	{"t", "jump to today and center/follow now", false},
	{"j / k", "scroll timeline one visual line", false},
	{"J / K", "jump to next / previous focus session", false},
